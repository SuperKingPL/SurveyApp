...
import Dot from '../components/circle';
            ...
            <div className="ChannelsBar">
                <div className="Mount1">
                    <div className="ServerQuickInfo">
                        <div className='flexRow'>{<ServerBadge/>}
                            <div className="flexColumn">
                                {ActiveGuild.CurrentGuild.name}
                                <div className="flexRow">
                                    <div className="circle green"/> 1234
                                    <div className="circle white" style={{marginLeft: "20px"}}/> 1234
                                </div>
                            </div>
